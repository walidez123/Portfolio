...
export default function About() {
  const skills = [
    { name: 'Frontend', items: ['React', 'TypeScript', 'Tailwind CSS', 'Next.js', 'Vue', "Redux","Zustand" ] },
    { name: 'Backend', items: ['Node.js', 'PHP', 'Laravel', 'Express', 'MongoDB', 'PostgreSQL',"MySQL" ,"Redis"] },
